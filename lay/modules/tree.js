						...
						var l = n.children && n.children.length > 0,
							...
							s = o(
									[
										...
										function() {
											return l ? '<i class="layui-icon layui-tree-spread"></i>' : '<i style="paddling-left: 28px;"></i>';
										}(), 
										function() {
										...
										function() {
											//label
											return '<label for="' + n.id + '"></label>'
										}(),
										function() {
											//a链接是否可点击
											return '<a href="' + (n.href || "javascript:;") + '" ' + (i.target && n.href ? 'target="' + i.target + '"' : "") + ">" + ("<cite>" + (n.name || "未命名") + "</cite></a>")
										}(), 
										"</li>"
									].join("")
								);
				...
				i.prototype.spread = function(e, o) {
					...
					var a = this,
						...
						l = function() {
							...
							e.data("spread") ? (e.data("spread", null), i.removeClass("layui-show"), r.removeClass("spread-active"), n.find(".layui-icon").html(t.branch[0])) : (e.data("spread", !0), i.addClass("layui-show"), r.addClass("spread-active"), n.find(".layui-icon").html(t.branch[1]))
						};
					//单击小箭头或双击整个节点都会展开会折起
