...
$("#operation6").jqGrid({
    ...
    datatype: function (data) {
        var thegrid = jQuery("#operation6")[0];
        data = eval("(" +'{"page":1,"total":2,"records":13,"rows":['
            +' {"ctn1":"1","ctn2":"C40混凝土","ctn3":"12","ctn4":"L","ctn5":"350","ctn6":"4200","ctn7":"耗材费","ctn8":"<a class=\'d-ib ta-c fs-12\'>编辑</a><a class=\'d-ib ta-c fs-12\'>删除</a>"}'
            +',{"ctn1":"1","ctn2":"C40混凝土","ctn3":"12","ctn4":"小时","ctn5":"350","ctn6":"4200","ctn7":"车辆租赁","ctn8":"<a class=\'d-ib ta-c fs-12\'>编辑</a><a class=\'d-ib ta-c fs-12\'>删除</a>"}'
